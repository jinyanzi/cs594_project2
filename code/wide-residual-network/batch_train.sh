...
#data='dataset=./datasets/cifar10_whitened.t7'
data='dataset=./datasets/cifar100_whitened.t7'
...
# resnet with different depth plus regular dropout
#res_depth=(11 47 164 227 1001)
#for d in "${res_depth[@]}";do
#	echo $d
#	model=resnet-pre-act depth=$d dropout=0.3 dataset=$data ./scripts/train_cifar.sh
#done
